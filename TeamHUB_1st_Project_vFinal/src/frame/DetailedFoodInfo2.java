...
import MainPage2.Diet2;
import MainPage2.Hot2;
import MainPage2.Meat2;
import MainPage2.Rain2;
import MainPage2.Seafood2;
import MainPage2.Sun2;
import MainPage2.Vegan2;
import ProductDB.Product;
import ProductDB.ProductDAO;

public class DetailedFoodInfo2 extends JPanel {
	...
	public DetailedFoodInfo2(Product product) { // 가상 DB 완성되면 매게변수 수정 (우선 product만 설정해서 넘겨받고 UI 수장)
		setLayout(null);
		setSize(500, 800);
